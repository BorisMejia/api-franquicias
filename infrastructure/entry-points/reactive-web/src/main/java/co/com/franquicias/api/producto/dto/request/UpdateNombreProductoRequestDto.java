...
@Schema(description = "DTO para actualizar el nombre de un producto")
public record UpdateNombreProductoRequestDto(
        ...
        Integer idProducto,
        @Schema(description = "Nuevo nombre para el producto", example = "Hamburguesa", required = true)
